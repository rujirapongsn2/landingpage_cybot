...
'hero.tagline': 'รวม Log Management, Security และ Monitoring ครบในอุปกรณ์เดียว — สั่งงานด้วยภาษาไทยได้ทันที',
    ...
    'faq.a1': 'รองรับตั้งแต่องค์กรขนาดกลางถึงองค์กรขนาดใหญ่ ด้วยลิขสิทธิ์แบบ Unlimited Devices และ Unlimited Volume ไม่จำกัดจำนวนอุปกรณ์หรือปริมาณ Log ต่อวัน',
    ...
    'faq.a6': 'ไม่มี — ลิขสิทธิ์เป็นแบบ Unlimited Devices และ Unlimited Volume ประมวลผลได้ไม่น้อยกว่า 7,000 EPS (เพิ่มได้ตามความต้องการ ปรึกษาทีมงานได้)',
    ...
    'faq.q8': 'ขอทดสอบระบบ (POC) ได้อย่างไร',
...
'hero.tagline': 'Log Management, Security & Monitoring in a single appliance — ask in plain language, act instantly',
    ...
    'faq.a1': 'From mid-size to large enterprises — licensing is Unlimited Devices and Unlimited Volume, with no cap on the number of devices or daily log volume.',
    ...
    'faq.a6': 'No — licensing is Unlimited Devices and Unlimited Volume, processing no fewer than 7,000 EPS (scalable on demand — talk to our team).',
    ...
    'faq.q8': 'How can we arrange a POC?',
